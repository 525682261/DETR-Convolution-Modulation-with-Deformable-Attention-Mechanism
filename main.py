...
# 相比较于DAB-DETR和DN-DETR DINO将项目相关的配置放到了config文件中
def get_args_parser():
    parser = argparse.ArgumentParser('Set transformer detector', add_help=False)
    parser.add_argument('--config_file', '-c',
                        default='/22085400503/ours-BITVehicle/config/DINO/DINO_4scale.py', type=str)
    ...
    parser.add_argument('--coco_path', type=str, default='/22085400503/data/coco_BITVehicle')
    parser.add_argument('--coco_panoptic_path', type=str)
    parser.add_argument('--remove_difficult', action='store_true')
    parser.add_argument('--fix_size', action='store_true')

    # training parameters
    parser.add_argument('--output_dir', default='/22085400503/ours-BITVehicle/logs/R50-MS4-12epoch',
    ...
    parser.add_argument('--start_epoch', default=0, type=int, metavar='N',
                        help='start epoch')
    parser.add_argument('--eval', action='store_true')  # default false true test false train
